...
def get_start_link(bot, payload: str, encode=False) -> str:
    """
...
def get_startgroup_link(bot, payload: str, encode=False) -> str:
    """
...
def _create_link(bot, link_type, payload: str, encode=False):
    """
    Create deep link.
    ...
    return f"https://t.me/{me.username}?{link_type}={payload}"
